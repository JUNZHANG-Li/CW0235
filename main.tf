...
resource "harvester_virtualmachine" "storagevm" {
  ...
  tags = {
    ...
    condenser_ingress_node_hostname = "node-ucabiqx"
...
resource "harvester_virtualmachine" "hostvm" {
  ...
  tags = {
    condenser_ingress_isAllowed              = true
    condenser_ingress_isEnabled              = true
   condenser_ingress_prometheus_hostname    = "prometheus-ucabiqx"
   condenser_ingress_prometheus_port        = 9090
   condenser_ingress_nodeexporter_hostname  = "nodeexporter-ucabiqx"
   condenser_ingress_nodeexporter_port      = 9100
   condenser_ingress_grafana_hostname       = "grafana-ucabiqx"
